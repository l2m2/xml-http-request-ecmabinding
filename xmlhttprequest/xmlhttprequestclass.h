#ifndef XMLHTTPREQUESTCLASS_H
#define XMLHTTPREQUESTCLASS_H

#include "xmlhttprequest_global.h"
...
class XMLHTTPREQUESTSHARED_EXPORT XMLHttpRequestClass : public QObject {
    Q_OBJECT
